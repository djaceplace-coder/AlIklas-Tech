...
const PRODUCTS = [
    ...
    { name: "Pylontech US5000 4.8kWh LiFePO4 Battery", category: "Batteries", price: "₦1,450,000", desc: "Industry standard lithium phosphate battery. 6000+ cycles at 90% DoD. Built-in smart BMS.", img: "https://images.unsplash.com/photo-1565800489013-c64859d0c2d5?auto=format&fit=crop&q=80&w=600", spec: "4.8kWh | 48V" },
    { name: "BYD Battery-Box Premium LVL 15.4", category: "Batteries", price: "₦4,800,000", desc: "High-capacity low voltage battery stack. Easily scalable up to 983kWh for parallel connections.", img: "https://images.unsplash.com/photo-1620714223084-8fcacc6dfd8d?auto=format&fit=crop&q=80&w=600", spec: "15.4kWh | Scaleable" },
    { name: "Felicity Solar 10kWh Wall-Mounted Battery", category: "Batteries", price: "₦2,100,000", desc: "Sleek wall-mounted design saving space while delivering 10kWh of deep-cycle LiFePO4 storage.", img: "https://images.unsplash.com/photo-1558449028-b53a39d100fc?auto=format&fit=crop&q=80&w=600", spec: "10kWh | Wall Mount" },
    { name: "HD Dual Lens Solar PTZ Camera", category: "Surveillance", price: "₦180,000", desc: "100% wire-free. 4G/WiFi enabled. Features dual lenses for wide-angle and telephoto viewing simultaneously.", img: "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?auto=format&fit=crop&q=80&w=600", spec: "4G | Dual Lens" },
    { name: "Schneider Electric Acti9 MCB (32A)", category: "Electricals", price: "₦12,500", desc: "Industrial-grade miniature circuit breaker providing ultimate protection against overloads and short circuits.", img: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80&w=600", spec: "32A | 3-Pole" },
    { name: "6mm DC Solar Cable (100m Roll)", category: "Electricals", price: "₦85,000", desc: "UV shielded, tinned copper dual-core solar cable rated for harsh Nigerian outdoor sun exposure.", img: "https://images.unsplash.com/photo-1558449028-b53a39d100fc?auto=format&fit=crop&q=80&w=600", spec: "6mm | UV Rated" },
    { name: "ABB AC Surge Protection Device (SPD)", category: "Electricals", price: "₦45,000", desc: "Critical Type 2 surge protector. Defends your sensitive inverters and appliances from grid voltage spikes.", img: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80&w=600", spec: "Type 2 | AC" },
    { name: "Complete Solar Home System (3kVA)", category: "Kits", price: "₦1,900,000", desc: "A bundle including a 3kVA inverter, 2.4kWh lithium battery, and 4x 450W panels. Perfect for a 2-bedroom flat.", img: "https://images.unsplash.com/photo-1518005020951-eccb494ad742?auto=format&fit=crop&q=80&w=600", spec: "Complete Kit" },
